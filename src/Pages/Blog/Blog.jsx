...
const Blog = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        'Explore the fascinating neuroscience and psychology behind how our brains process and learn new languages, and what it means for your learning approach.',
      content:
    ...
    <div className="bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {selectedCategory === 'All' && featuredPost && (
          <FeaturedBlogs featuredPost={featuredPost} categoryIcons={categoryIcons} />
        )}
        ...
        <LatestBlog filteredPosts={filteredPosts} categoryIcons={categoryIcons} />
      </div>
      ...
      <div className="bg-gradient-to-r from-gray-950 via-purple-800 to-gray-900    py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8">
              Subscribe to get the latest articles and exclusive resources delivered to
              your inbox
            </p>
