                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4 pt-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="text-white font-semibold text-lg">Access Premium Features</h3>
                                            <p className="text-white/80">Unlock all courses and learning materials</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                        <div className="w-12 h-12 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-white/80">Connect with fellow learners worldwide</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
