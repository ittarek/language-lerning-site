  ...
  const newsArticles = [
    {
      id: 1,
      title:
        'Duolingo Reaches 500 Million Users Worldwide, Revolutionizing Language Learning',
      excerpt:
        'The popular language learning app celebrates a major milestone, with users across 195 countries learning over 40 languages through gamified lessons.',
      content:
    ...
    },
    {
      id: 2,
      title:
        "New Study Reveals Learning Multiple Languages Delays Alzheimer's by 5 Years",
      excerpt:
        'Groundbreaking research from Cambridge University shows bilingualism provides significant cognitive protection against dementia and age-related cognitive decline.',
      content:
    ...
    },
    {
      ...
      excerpt:
        'Advanced AI-powered language learning tools demonstrate comparable results to traditional human instruction, marking a new era in language education technology.',
      content:
    ...
    },
    {
      id: 5,
      title:
        'Virtual Reality Language Immersion Programs Show 200% Faster Learning Results',
      excerpt:
        'New VR technology creates realistic immersive environments, allowing learners to practice languages in simulated real-world scenarios with remarkable effectiveness.',
      content:
