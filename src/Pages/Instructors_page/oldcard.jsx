...
//           {/* Name */}
//           <h1
//             className="absolute bottom-0 font-bold text-center whitespace-nowrap transition-all duration-300 pb-6"
//             style={{
...
//         {/* About Section */}
//         <div
//           className={`${activeSection === 'about' ? 'block animate-fadeIn' : 'hidden'}`}>
//           <div className="p-5">
...
//             <a
//               href="#"
//               className="h-8 w-8 rounded-full inline-flex items-center justify-center transition-all duration-300 bg-blue-50 hover:bg-blue-100 mr-2.5">
...
//             <a
//               href="#"
//               className="h-8 w-8 rounded-full inline-flex items-center justify-center transition-all duration-300 bg-blue-50 hover:bg-blue-100">
...
//                   </span>
//                 </div>
//                 <div className="font-medium text-[14px] mb-1.5">
//                   Senior Language Instructor
//                 </div>
//                 <div className="text-[13px] text-gray-600 leading-relaxed">
//                   Teaching advanced language courses and developing curriculum for
...
//                 <div className="text-[13px] text-gray-600 leading-relaxed">
//                   Created engaging learning materials and interactive lessons for online
//                   platforms.
//                 </div>
//               </div>
...
//                 <div className="text-[13px] text-gray-600 leading-relaxed">
//                   Provided one-on-one tutoring sessions for beginner and intermediate
//                   students.
//                 </div>
//               </div>
//             </div>
