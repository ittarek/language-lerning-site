        ...
        <div className=" max-w-7xl mx-auto   py-2">
          ...
          <Container className="relative h-full flex flex-col justify-end pb-12">
            ...
            <div className="text-white space-y-4">
              ...
              <h1 className="text-5xl font-bold max-w-4xl leading-tight">{class_name}</h1>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-2 flex gap-2 overflow-x-auto">
              {['overview', 'curriculum', 'instructor', 'reviews'].map(tab => (
                <button
                  ...
                  className={`px-6 py-3 rounded-xl font-semibold capitalize whitespace-nowrap transition-all duration-300 ${
                    activeTab === tab
                    ...
                    {tags && tags.length > 0 && (
                      <div className="flex flex-wrap gap-2 mt-6">
                        {tags.map((tag, idx) => (
                          <span
                            key={idx}
                            className="px-4 py-2 bg-indigo-50 text-indigo-600 rounded-full text-sm font-semibold hover:bg-indigo-100 transition cursor-pointer">
                            #{tag}
                          </span>
                        ))}
                      </div>
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl shadow-lg p-8 border-2 border-green-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {what_you_will_learn.map((item, idx) => (
                        <div
                          key={idx}
                          className="flex items-start gap-3 bg-white rounded-lg p-4 hover:shadow-md transition">
                  ...
                  <div className="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {skills_gained.map((skill, idx) => (
                        <span
                          key={idx}
                          className="px-4 py-2 bg-purple-100 text-purple-700 rounded-lg font-semibold hover:bg-purple-200 transition cursor-pointer">
                          {skill}
                        </span>
                      ))}
                    </div>
              ...
              <div className="space-y-6">
                {modules && modules.length > 0 ? (
                  modules.map((module, idx) => (
                    <div
                      key={idx}
                      className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 hover:border-indigo-300 transition">
                      <button
                  ...
                  <div className="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <ul className="space-y-3">
                      {curriculum.map((topic, idx) => (
                        <li
                          key={idx}
                          className="flex items-center gap-3 text-gray-700 p-3 hover:bg-gray-50 rounded-lg transition">
                      ...
                      <div className="space-y-2">
                        {Object.entries(rating_breakdown)
                          ...
                          .map(([key, value]) => {
                            ...
                            const percentage = total_reviews
                              ? Math.round((value / total_reviews) * 100)
                              : 0;
                            return (
            ...
            <div className="sticky top-24 bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl shadow-2xl p-8 text-white space-y-6">
              ...
              <div className="border-b border-white/20 pb-6">
                ...
                {original_price && original_price > price && (
                  <div className="mt-3 flex items-center gap-3">
                    <span className="text-indigo-200 line-through text-xl">
                      ${original_price}
                    </span>
                    {discount_percentage && (
              ...
              <div className="border-t border-b border-white/20 py-6">
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-indigo-200">
                    <span className="font-semibold text-white">{available_seats}</span>{' '}
                    seats remaining
                  </p>
                </div>
              </div>
              ...
              <div className="text-center space-y-2">
                {recommended_age && (
                  <p className="text-sm text-indigo-200">
                    Recommended age:{' '}
                    <span className="font-semibold text-white">{recommended_age}</span>
                  </p>
                )}
