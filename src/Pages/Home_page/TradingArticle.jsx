...
const news = [
    {
        ...
        date: "Dec 20, 2024",
        details: "Discover proven strategies that can help you master a new language in record time. From immersion techniques to digital tools.",
        comments: "24",
    ...
    },
    {
        ...
        date: "Dec 18, 2024",
        details: "Explore the neurological processes that occur when adults learn new languages and how to optimize your learning potential.",
        comments: "18",
    ...
    },
    {
        ...
        date: "Dec 15, 2024",
        details: "Understanding culture is just as important as learning grammar. Here's why immersion makes all the difference.",
        comments: "31",
    ...
    },
    {
        ...
        date: "Dec 12, 2024",
        details: "From AI-powered apps to virtual reality experiences, discover the best technology for accelerated language learning.",
        comments: "42",
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div className="space-y-2">
                            ...
                            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900">
                                Trending <span className="bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">Articles</span>
                            </h2>
                                        ...
                                        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <button className="p-2 hover:bg-gray-100 rounded-full transition-colors group/share">
                                                    <svg className="w-5 h-5 text-gray-400 group-hover/share:text-red-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <button className="p-2 hover:bg-gray-100 rounded-full transition-colors group/bookmark">
                                                    <svg className="w-5 h-5 text-gray-400 group-hover/bookmark:text-red-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
