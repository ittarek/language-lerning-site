    ...
    return (
        <Container>
            <div className="my-11 mx-11">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-11 md:gap-0 mx-auto">
                    {news.map((n, index) => (
                        <div key={index} className=" ">
                            <div>
                                <img
                                    className="md:w-[250px] h-[250px] md:hover:scale-110 transition duration-500 cursor-pointer object-cover rounded-lg mx:auto"
                                    src={n.img}
                                    alt=""
                                />
                            </div>
                            <div className="card p-3  lg:w-[400px]  bg-[#FFFFFF] relative md:-top-[220px] md:left-[190px] shadow-xl">
                                <h1>{n.title}</h1>
