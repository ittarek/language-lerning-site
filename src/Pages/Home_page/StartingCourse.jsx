    ...
    <Container>
      ...
      <div className="grid grid-cols-1 gap-[50px] xl:grid-cols-3 mx-11">
        {courseData.map((course, index) => (
          <div className="card card-compact w-full bg-base-100 shadow-xl hover:-translate-x-5 hover:transform-origin-top transition duration-500 hover:bg-orange-300 ">
            <figure>
              <img
