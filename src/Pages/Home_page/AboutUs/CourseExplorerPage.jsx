...
export function CourseExplorerPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Course Explorer - Language Learning Platform</title>
        <meta
          name="description"
          content="Explore our wide range of language courses tailored to your needs. Find the perfect course to start your learning journey today!"
        />
      </Helmet>
