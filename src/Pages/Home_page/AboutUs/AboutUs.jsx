                                ...
                                <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-xl">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <div className="font-semibold text-indigo-600">Trusted Globally</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className={`space-y-8 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-20 opacity-0'}`}>
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed">
                                ...
                                Our platform combines cutting-edge technology with proven teaching methods to deliver
                                exceptional results.
                            </p>
                            <p className="text-gray-600 leading-relaxed">
                                With expert instructors, interactive courses, and a supportive global community,
                                we've helped thousands of students achieve their language learning goals and unlock
                        ...
                        <div className="flex flex-wrap gap-4 pt-4">
                            <button className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full font-bold hover:shadow-lg hover:shadow-indigo-500/50 transform hover:scale-105 transition-all duration-300 flex items-center gap-2">
                                Start Learning Today
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                </svg>
                            </button>
                            <button className="px-8 py-4 bg-white border-2 border-indigo-600 text-indigo-600 rounded-full font-bold hover:bg-indigo-50 transition-all duration-300">
                                Learn More
                            </button>
                        </div>
                    </div>
