      ...
      <div className="my-11">
        ...
        <div className="lg:flex justify-between items-center gap-24  lg:mx-24 mx-6 ">
          {planing.map((plan, index) => (
            <div
              key={index}
              className={` w-full my-11 text-neutral-content h-[400px] ${
                plan.name === "Yearly" ? "bg-[#FFB20E]" : "bg-[#1EAACE]"
              }
          `}
            >
              <div className=" text-center">
                <div className="w-full bg-purple-100   -mt-8 ">
                  {" "}
                  <p
                    className={` py-3 uppercase text-4xl  text-white ${
                      plan.name === "Yearly" ? "bg-[#E5A00D]" : "bg-[#1B99B9]"
                    }
          `}
                  >
                    {plan.name}
