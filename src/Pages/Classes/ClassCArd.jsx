...
const ClassCArd = ({ classes, refetch }) => {
    ...
    return (
        <Container>
            <div
                className={`class__item p-1 sm:w-full h-full card rounded-3xl hover:bg-transparent hover:border-sky-200 bg-slate-300   transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 border-l-4 border-white ${available_seats === 0 ? "bg-red-400" : ""
                    }`}
            // data-aos="fade-up"
            >
