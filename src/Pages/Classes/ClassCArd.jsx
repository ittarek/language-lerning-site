        ...
        >
            ...
            <div className="relative overflow-hidden h-56">
                <img
                    ...
                    alt={class_name}
                    className={`w-full h-full object-cover transition-transform duration-500 ${isDisabled ? 'scale-100' : 'group-hover:scale-110'
                        }`}
                />
            ...
            <div className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                    {/* Available Seats */}
                    <div className={`rounded-xl p-3 text-center transition-colors ${available_seats === 0 ? 'bg-red-50' : 'bg-blue-50 group-hover:bg-blue-100'
                        }`}>
                        <FaChair className={`mx-auto mb-1 text-lg ${available_seats === 0 ? 'text-red-600' : 'text-blue-600'
                            }`} />
                        <div className={`text-lg font-bold ${available_seats === 0 ? 'text-red-600' : 'text-gray-800'
                            }`}>
                            {available_seats}
                        </div>
                ...
                <button
                    ...
                    className={`w-full py-3 rounded-b-xl font-bold transition-all duration-300 flex items-center justify-center gap-2 bottom-0 absolute left-0  ${isDisabled || isLoading || isCheckingSelection
