    ...
    const allEvents = [
        {
            ...
            instructorBio: "María is a certified Spanish teacher from Madrid with over 10 years of experience. She specializes in conversational Spanish and has helped thousands of students gain confidence in speaking.",
            level: "Beginner",
            language: "Spanish",
        ...
        },
        {
            ...
            instructorBio: "Takeshi is a tea ceremony master and Japanese language instructor. Born in Kyoto, he has been teaching Japanese culture and language for 15 years.",
            level: "All Levels",
            language: "Japanese",
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
                ...
                <Container>
                    <div className="absolute bottom-8 left-0 right-0">
                        ...
                        <div className="flex flex-wrap gap-3 mb-4">
                            ...
                            <span className={`${event.type === 'Virtual' ? 'bg-blue-500' : 'bg-green-500'
                ...
                <div className="py-12 max-w-7xl mx-auto">
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            {/* What You'll Learn */}
                            <div className="bg-white rounded-2xl shadow-lg p-8">
                                <h2 className="text-2xl font-bold text-gray-800 mb-6">What You'll Gain</h2>
                                ...
                                <div className="bg-white rounded-2xl shadow-xl p-6 border-2 border-indigo-100">
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                                            <div
                                                className={`h-full rounded-full transition-all ${isAlmostFull ? 'bg-red-500' : 'bg-green-500'
                                                    }`}
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-500 text-xs">Duration: {event.duration}</p>
                                            </div>
                                        </div>
            ...
            <div className="bg-gray-100 py-16 max-w-7xl mx-auto">
                <Container>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8">More Events You Might Like</h2>
                    <div className="grid md:grid-cols-3 gap-6">
                        {allEvents?.filter(e => e.id !== event.id).slice(0, 3)?.map(relatedEvent => (
                            <Link
                                key={relatedEvent.id}
