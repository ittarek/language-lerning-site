...
const Events = () => {
    ...
    const events = [
        {
            ...
            description: "Join us for an immersive Spanish conversation evening! Practice your speaking skills in a relaxed, supportive environment with native speakers and fellow learners.",
            date: "2025-01-15",
        ...
        },
        {
            ...
            description: "Experience authentic Japanese culture while learning essential language phrases. This workshop combines traditional tea ceremony with practical Japanese language instruction.",
            date: "2025-01-20",
        ...
        },
        {
            ...
            description: "Weekly gathering for advanced French learners to discuss literature, current events, and culture. Sharpen your skills through engaging debates and discussions.",
            date: "2025-01-18",
        ...
        },
        {
            ...
            description: "Essential Mandarin phrases and cultural insights for business professionals. Learn negotiation tactics, formal greetings, and professional correspondence.",
            date: "2025-01-25",
        ...
        },
        {
            ...
            description: "Learn to cook authentic Italian dishes while practicing Italian language! Follow recipes in Italian and learn culinary vocabulary hands-on.",
            date: "2025-01-22",
        ...
        },
        {
            ...
            description: "Master German grammar in one intensive session! Focus on cases, verb conjugations, and sentence structure with expert guidance and practice exercises.",
            date: "2025-01-28",
        ...
        },
        {
            ...
            description: "Meet language learners from around the world! Practice multiple languages, make international friends, and participate in fun language games and activities.",
            date: "2025-02-05",
        ...
        },
        {
            ...
            description: "Planning a trip to Brazil or Portugal? Learn essential travel phrases, navigation terms, and cultural tips in this fast-paced, practical course.",
            date: "2025-02-10",
    ...
    const categories = ['All', 'Practice Session', 'Workshop', 'Masterclass', 'Meetup', 'Cultural Workshop', 'Social Event', 'Crash Course'];
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <div className=" max-w-7xl mx-auto rounded-t-xl bg-gradient-to-br from-gray-950 via-purple-800 to-gray-900   py-20">
                ...
                <div className="text-center mx-auto">
                    ...
                    <p className="text-xl text-white/90 mb-8">
                        Join our community events, workshops, and practice sessions to accelerate your language learning journey
                    </p>
            ...
            {/* Filters */}
            <div className="sticky top-20 z-40 bg-white shadow-md max-w-7xl mx-auto">
                <Container>
                    <div className="py-4">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {types.map(type => (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-full text-sm font-semibold transition-all ${selectedType === type
            ...
            <Container>
                <div className="py-16 max-w-7xl mx-auto">
                    ...
                    {/* Featured Events */}
                    {selectedCategory === 'All' && selectedType === 'All' && featuredEvents.length > 0 && (
                        <div className="mb-16">
                                        ...
                                        <div className="grid md:grid-cols-2">
                                            <div className="relative h-64 md:h-auto overflow-hidden">
                                                ...
                                                <div className="absolute top-4 right-4">
                                                    <span className={`${event.type === 'Virtual'
                                                        ? 'bg-blue-500'
                                                        : 'bg-green-500'
                                                        } text-white px-3 py-1 rounded-full text-sm font-bold`}>
                                                        {event.type === 'Virtual' ? <FaVideo className="inline mr-1" /> : <FaMapMarkerAlt className="inline mr-1" />}
                                                        {event.type}
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="p-6 flex flex-col">
                                                ...
                                                <div className="space-y-2 mb-4 text-sm text-gray-600">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span>{event.seatsLeft} seats left out of {event.seats}</span>
                                                    </div>
                                                </div>
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h2 className="text-3xl font-bold text-gray-800">
                                {selectedCategory === 'All' && selectedType === 'All' ? 'Upcoming Events' : 'Filtered Events'}
                            </h2>
            ...
            <div className="max-w-7xl mx-auto  rounded-xl bg-gradient-to-r from-gray-950 via-purple-800 to-gray-900   py-20">
                <Container>
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-xl text-white/90 mb-8">
                            Suggest an event or join our community to stay updated on new workshops and meetups
                        </p>
