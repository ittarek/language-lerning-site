        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div>
                ...
                <p className="text-gray-400 leading-relaxed mb-6">
                  Empowering learners worldwide with innovative language education. Master
                  any language with expert instructors and cutting-edge learning methods.
                </p>
              </div>
                ...
                {footerLinks.courses.map(link => (
                  <li key={link.name}>
                    <a
                      ...
                      <svg
                        className="w-4 h-4 text-indigo-500 group-hover:translate-x-1 transition-transform"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...footerLinks.support.slice(0, 3),
                  ...footerLinks.legal.slice(0, 2),
                ].map(link => (
                  <li key={link.name}>
                    <a
                      href={link.href}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-gray-400 text-sm text-center md:text-left">
                © {currentYear} Language Center. All rights reserved. Made with ❤️ for
                learners worldwide.
              </p>
