...
//           axiosSecure.post("/paidCourses", enrollMentCourse).then((res) => {
//             if (res.data.insertedId) {
//               // console.log('enrolled');

//               axiosSecure
//                 .patch(`/reduceSeats/${selectCourse.courseId}`)
//                 .then((res) => {
...
//         />
//         <button
//           className="btn btn-primary btn-sm mt-4 w-2/3 mx-auto"
//           type="submit"
...
//           Transaction is complete with TransactionID: {transactionId}
//         </p>
//       )}
//     </div>
//   );
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
                ...
                className={`w-full py-3 rounded-lg font-semibold text-white transition duration-300 flex items-center justify-center gap-2 ${processing || !stripe || !elements || !clientSecret
